...
<body class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      <li><a class="app-menu__item active" href="principal.html"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Inicio</span></a></li>
      ...
      <div>
        <form action="" method="POST">
          ...
          try {
            ...
            $sql = "SELECT * FROM persona INNER JOIN rol ON (fk_rol=id_rol) WHERE id_persona= " . $_REQUEST['cod'] . " ";
            $resultado = $base->prepare($sql);
            $resultado->execute(array());
            while ($consulta = $resultado->fetch(PDO::FETCH_ASSOC)) {
              ?>
              <div>
                <label for="">Identidicacion</label>
              ...
              <div>
                <label for="">Rol</label>
                <td> <input class="form-control" type="text" name="cuatro" value="<?php echo $consulta['fk_rol'] ?>"> </td>
              </div>
              <div>
                <label for="">login</label>
                <td> <input class="form-control" type="text" name="cinco" value="<?php echo $consulta['login'] ?>"> </td>
              </div>
              <br>

              <div>
                <td><a name="btn1" class="btn btn-primary" href="php/actualizar_ope.php?act=<?php echo $_REQUEST['COD'] ?> ">Modificar</a></td>
              </div>
            <?php
            }
          } catch (excepcion $ex) {
