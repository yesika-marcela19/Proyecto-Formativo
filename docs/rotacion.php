...
<body class="app sidebar-mini rtl">
  ...
  <header class="app-header"><a class="app-header__logo" href="index.html">Vali</a>
    ...
    <ul class="app-nav">
      ...
      <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Show notifications"><i class="fa fa-bell-o fa-lg"></i></a>
        <ul class="app-notification dropdown-menu dropdown-menu-right">
          ...
          <div class="app-notification__content">
            ...
            <main class="app-content">
             ...
             <form  method="POST">  
              <div class="app-title">
                ...
                <h1><i class="fa fa-dashboard"></i>Registro de rotacion</h1>
              </div>  
            </div>
            ...
            <div>
             ...
             <div>
               ...
               <input type="Date" name="fecha" placeholder="ingrese fecha"  class="form-control">
             </div>
             <div>
               <label for="">Seleccione estanque origen </label>
               <select  name="estanque1" id="estanque"  class="form-control">
                <?php 
                try{
         ...
         <div>
          <label for="">Seleccione lote origen</label>
          <select class="form-control"name="lote1" id="" class="form_control">
           ...
           try{
            ...
            $query="SELECT id_lote from lote";
            $data=$base->prepare($query);
            $data->execute();
    ...
    <div>
      <br>
      <label for="" class="control-label"> Mover a </label>
      <br>
    </div>


    <div>
     <label for="">Seleccione estanque destino</label>
     <select  name="estanque2" id="estanque"  class="form-control">
      <?php 
      try{
...
<div>
  <label for="">Seleccione lote destino</label>
  <select class="form-control" name="lote2" id="" class="form_control">
...
<div>
  <br>
  <input class="btn btn-primary" type="submit" name="btn1" value="registrar" >
</div>
...
if(isset($_POST['btn1'])){
  ...
  if($sql== true){
   $sql="INSERT INTO `actividad`(`id_actividad`,`cantidad`, `descripcion`, `fecha`, `fk_estanque`, `fk_tipo_actividad`,`lote`) VALUES ('',:uno,:dos,:tres,:cuatro,:seis,:siete)";		
   $resultado=$base->prepare($sql);
   $resultado->execute(array(":uno"=>$n1,":dos"=>$n2,":tres"=>$n3,":cuatro"=>$n8,":seis"=>$n6,":siete"=>$n9));
   if($n7!= ""){
