              ...
              <aside class="app-sidebar">
                ...
                <ul class="app-menu">
                 ...
                 <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Reportes</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                  <ul class="treeview-menu">
                    <li><a class="treeview-item" href="php/consulta_alimentacion.php"><i class="icon fa fa-circle-o"></i>Alimentacion</a></li>
                    <li><a class="treeview-item" href="php/consulta_rotacion.php"><i class="icon fa fa-circle-o"></i> Rotacion</a></li>
                    <li><a class="treeview-item" href="php/consulta_muestreo"><i class="icon fa fa-circle-o"></i> Muestreo</a></li>
                    <li><a class="treeview-item" href="php/consulta_pesca.php"><i class="icon fa fa-circle-o"></i>Pesca</a></li>
                    <li><a class="treeview-item" href="php/consulta_produccion.php"><i class="icon fa fa-circle-o"></i>Produccion</a></li>
                    <li><a class="treeview-item" href="php/consulta_mortalidad.php"><i class="icon fa fa-circle-o"></i>Mortalida</a></li>
                  </ul>
                </li>
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Administrar</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                  <ul class="treeview-menu">
                    <li><a class="treeview-item" href="table-basic.html"><i class="icon fa fa-circle-o"></i> Administrador</a></li>
                    <li><a class="treeview-item" href="table-data-table.html"><i class="icon fa fa-circle-o"></i> Operario</a></li>
                  </ul>
                </li>
