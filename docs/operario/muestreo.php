...
<body class="app sidebar-mini rtl">
 ...
 <aside class="app-sidebar">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div>
                    ...
                    <input type="Date" name="fecha" placeholder="Ingrese fecha" value="<?php echo date("Y-m-d");?>" class="form-control" required>
                </div>
              </div>
              <div class="col-md-6">
                <div>
    ...
    <div>
      <br>
      <center><input class="btn btn-primary" type="submit" name="btn1" value="Registrar Muestro" ></center>
    </div>
