...
<li class="dropdown">
 ...
 <aside class="app-sidebar">
    ...
    <main class="app-content">
             ...
             <form  method="POST" action="php/R_rotacion.php">  
            <div class="app-title">
               
                <h1><i class="fa fa-dashboard"></i>Registro de rotación</h1>
              </div>  
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div>
                        <label for="">Estanque origen </label>
                        <select  name="estanque1" id="estanque1"  class="form-control" required>
                        <?php 
                        try{
                ...
                <div class="col-md-6">
                    ...
                    <div>
                        <label for="">Estanque destino</label>
                        <select  name="estanque2" id="estanque2"  class="form-control">
                          <?php 
                          try
                          {
                            $query="SELECT estanque FROM calcular_alimentacion_semana_actual";
            ...
            <div>
                <br>
                <center><input class="btn btn-primary" type="submit" name="btn1" value="Registrar Rotación" ></center>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#estanque1').change(function(){
            recargarLista1();
        });

        $('#estanque2').change(function(){
            recargarLista2();
        });
    })
</script>
