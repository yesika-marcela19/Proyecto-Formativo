...
<body class="app sidebar-mini rtl">
  ...
  <header class="app-header">
   ...
   <main class="app-content">           
              <div class="app-title">
                <h1><i class="fa fa-dashboard"></i>Registro de alimentación</h1>
              </div>  
              <div class="row">
                <div class="col-md-6">
                  <form action="php/R_alimento.php" method="POST"> 
                    <div>
                    ...
                    <div>
                        <br>
                        <center><input class="btn btn-primary" type="submit" name="btn1" value="Registrar Alimentación" ></center>
                    </div>
                  </form>
                </div>
                    ...
                    <div class="tile-body">
                      <table class="table table-hover table-bordered " id="sampleTable">
                        ...
                        <tbody>
                          <?php
                          try{
                            $sql="SELECT id_lote ,nombre_especie,semana,total_diario,fecha_actual from calcular_alimentacion_semana_actual group by  id_lote ";
                            ...
                            while($consulta=$resul->fetch(PDO::FETCH_ASSOC)){
                              ...
                              <tr>                            
                                ...
                                <th><?php echo$consulta['fecha_actual'];?></th>
                                <td><?php echo$consulta['nombre_especie'];?></td>
                                <td><?php echo$consulta['semana'];?></td>
                                <td><?php echo$consulta['total_diario'];?></td>           
                              </tr>
                              <?php
                            }
                          }
