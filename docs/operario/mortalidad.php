    ...
    <main class="app-content">
        ...
        <div class="col-md-12">
           <div>
             ...
             <td><input type="text
               " name="descripcion" placeholder="Ingrese descripcion"  class="form-control" required></td>
             </div>
        ...
        <div>
          <br>
          <center><input class="btn btn-primary" type="submit" name="btn1" value="Registrar Mortalidad" ></center>
        </div>
</form>  
