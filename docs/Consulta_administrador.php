...
<head>
  ...
  <script type="text/javascript" class="text-primary">
          ...
          <div class="app-notification__content">
            ...
            <main class="app-content">
              <form action="" method="POST">
                <div class="app-title">
                  <div>
                    <h1><i class="fa fa-th-list"></i>Adminstradores</h1>
                  </div>
                      ...
                      <div class="tile-body">
                        <table class="table table-hover table-responsive" id="sampleTable">
                          ...
                          <tbody>
                            <?php
                            try{
                              $sql="SELECT  * FROM  persona where fk_rol=1 and estado_pers=1" ;
                              ...
                              while($consulta=$resul->fetch(PDO::FETCH_ASSOC)){
                                ...
                                <tr>	 							 						
                                  ...
                                  <th>
                                    <span id="id_persona<?php echo$consulta['id_persona'];?>"><?php echo$consulta['fk_rol'];?></span>
                                  </th>

                                  <th>
                                    <span id="nombre<?php echo$consulta['id_persona'];?>"><?php echo$consulta['estado_pers'];?></span>
                                  </th>




                                  <td ><a class="btn btn-success edit" onclick='return ConfirmarUpdate();'href="php/desabilitar_admin.php?cod=<?php echo $consulta['id_persona']?>"><i class='material-icons' title=Actualizar Registro>Desabilitar</i></a></button></td>
