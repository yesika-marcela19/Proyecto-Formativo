...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <div  class="row d-flex justify-content-center" >
            ...
            <tbody>
              <?php
              try{
                $sql="SELECT  * FROM  actividad INNER JOIN persona ON (fk_persona=id_persona) WHERE fk_tipo_actividad=3";
                $resul=$base->prepare($sql);
                $resul->execute(array());
                while($consulta=$resul->fetch(PDO::FETCH_ASSOC)){
                  ?>
  ...
  <td>
      <a href="../reportes/mortalidad.php" class="btn btn-primary"> Descargar </a>
  </td>
    </div>
    </div>
    </div>
