                    ...
                    <div class="tile-body">
                      <table class="table table-hover table-bordered " id="sampleTable">
                        ...
                        <tbody>
                          <?php
                          try{
                            $sql="SELECT id_persona,nombre,telefono,nombre_rol,login,`estado_pers`=1,'Activo'  AS estado_pers FROM  persona inner join rol on (id_rol=fk_rol) where fk_rol=2 AND estado_pers=1" ;
                            $resul=$base->prepare($sql);
                            $resul->execute(array());
                            while($consulta=$resul->fetch(PDO::FETCH_ASSOC)){
                              ?>   <tr>                           
                                ...
                                <td ><a class="btn btn-secondary edit" style="width:100px;" onclick='return ConfirmarUpdate();' href="php/desabilitar_operario.php?cod=<?php echo $consulta['id_persona']?>"><i class='material-icons' title=Actualizar Registro>Deshabilitar</i></a></button></td>
                                
                                <td ><a class="btn btn-primary edit" style="width:100px;" href="actualizar_operario.php?enviar=<?php echo $consulta['id_persona']?>"><i class='material-icons' >Actualizar</i></a></td>
