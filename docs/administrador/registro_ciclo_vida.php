...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="app-content">
     <form method="POST" action="php/R_ciclo_vida.php">
        <div class="app-title">

            <h1><i class="fa fa-dashboard"></i>Registro de ciclo vida</h1>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div>
                   <label for="exampleInputPassword1">Semana</label>
                   <td><input type="number" name="semana" placeholder="Ingrese semana" class="form-control" required></td>
                </div>
                <div>
                    <label for="exampleInputPassword1">Consumo diario</label>
                    <td><input type="number" name="consumo1" placeholder="Ingrese diario" class="form-control" required></td>
                </div>
                <div>
                    <label for="exampleInputPassword1">Consumo semanal</label>
                    <td><input type="number" name="consumo2" placeholder="Ingrese semanal" class="form-control" required></td>
                </div>
            </div>
            <div class="col-md-6">
                <div>
                   <label for="exampleInputPassword1">Peso minimo </label>
                   <td><input type="number" name="pesomin" placeholder="Ingrese peso minimo" class="form-control" required></td>
                </div>
                <div>
                    <label for="exampleInputPassword1">Peso máximo </label>
                    <td><input type="number" name="pesomax" placeholder="Ingrese peso maximo" class="form-control" required></td>
                </div>
                <div>
    ...
    <div>
        <td>
            <center><input type="submit" name="btn1" class="btn btn-primary" value="Registrar ciclo de vida"></center>
        </td>
    </div>
</form>
