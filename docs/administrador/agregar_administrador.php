...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="app-content">
             <form method="POST" action="php/R_administrador.php">
            <div class="app-title">

                <h1><i class="fa fa-dashboard"></i>Registro de administrador</h1>
            </div>
            </div>

            <div>
                <label for="exampleInputPassword1">Identificación</label>
                <td><input type="number" name="identi" placeholder="Ingrese identificación" class="form-control" required></td>
            </div>

            <div>
                <label for="exampleInputPassword1">Nombre</label>
                <td><input type="text" name="nombre" placeholder="Ingrese nombre" class="form-control" required></td>
            </div>

            <div>
                <label for="exampleInputPassword1">Telefono</label>
                <td><input type="text" name="telef" placeholder="Ingrese telefono" class="form-control" required></td>
            </div>


                <div>
                    <label for="exampleInputPassword1">Usuario</label>
                    <td><input type="gmail" name="login" placeholder="Ingrese usuario" class="form-control" required></td>
                </div>
                <div>
                    <label for="exampleInputPassword1">Contraseña</label>
                    <td><input type="password" name="contra" placeholder="Ingrese contraseña" class="form-control" required></td>
                </div>
                <br>
                <div>
                    <td>
                        <center><input type="submit" name="btn1" class="btn btn-primary" value="Registrar administrador"></center>
                    </td>
                </div>
        </form>
