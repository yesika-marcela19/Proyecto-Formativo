...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="app-content">
              <div class="app-title">
                <div>
                  <h1><i class="fa fa-th-list"></i> Lotes registrados</h1>
                </div>
                    ...
                    <div class="tile-body">
                      <table class="table table-hover table-bordered " id="sampleTable">
                        ...
                        <tbody>
                          <?php
                          try{
                            $sql="SELECT id_lote,cantidad,fecha_ingreso,fecha_salida,fk_estanque,nombre_especie FROM  lote inner join tipo_especie on (id_tipo_especie=fk_tipo_especie)  inner join  estanque on (id_estanque=fk_estanque) where estado_lote=1";
                            $resul=$base->prepare($sql);
                            $resul->execute(array());
                            while($consulta=$resul->fetch(PDO::FETCH_ASSOC)){
                              ?>
                              <tr>                            
                                ...
                                <td><?php echo$consulta['fecha_ingreso'];?></td>
                                <td><?php echo$consulta['fecha_salida'];?></td>
