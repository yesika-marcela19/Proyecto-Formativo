...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="app-content">
             <form method="POST" action="php/R_bateria.php">
            <div class="app-title">

                <h1><i class="fa fa-dashboard"></i>Registro de bateria</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <label for="exampleInputPassword1">Nombre de bateria</label>
                    <td><input type="text" name="uno" placeholder="Ingrese bateria" class="form-control" required></td>
                </div>
                <div class="col-md-1">
            ...
            <div>
                <td>
                     <center><input type="submit" name="btn1" class="btn btn-primary" value="Registrar bateria "></center>
                </td>
            </div>
        </form>
            <!---
