...
<!-- FINAL ASIDE----------------------------------------------------------------------------------------------------------------------------->
    ...
    <main class="app-content">
             <form method="POST" action="php/R_lote.php">
            <div class="app-title">

                <h1><i class="fa fa-dashboard"></i>Registro de lote</h1>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div>
                        <label for="exampleInputPassword1">Cantidad</label>
                        <td><input type="number" name="uno" placeholder="Ingrese cantidad" class="form-control"></td>
                    </div>
                    <div>
                        <label for="exampleInputPassword1"> Estanque </label>
                        <select  name="cuatro" id="estanque"  class="form-control">
                        <option>Seleccione estanque</option>
                        <?php 
                            try
                            {
                                $query="SELECT est.id_estanque,est.tipo_estanque from estanque  est inner join lote lt on lt.fk_estanque = est.id_estanque where est.id_estanque not in(select l.fk_estanque from lote l where l.estado_lote = 1 ) and lt.estado_lote = 0 ";
                                $data=$base->prepare($query);
                                $data->execute();

                                while( $row=$data->fetch(PDO::FETCH_ASSOC))
                                {
                                    echo"<option value=".$row["id_estanque"]."'>".$row["id_estanque"]." </option>";                                   
                                }
                            }
                            catch(exception $e)
                            {
                ...
                <div class="col-md-6">
                    <div>
                       ...
                       <td><input type="date" name="dos" placeholder="" class="form-control"></td>
                   </div>
                   <div>
                      <label for="exampleInputPassword1">Fecha de salida</label>
                       <td><input type="date" name="tres" placeholder="" class="form-control"></td>
                   </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div>
                        ...
                        <select  name="cinco" id="estanque"  class="form-control">
            ...
            <div>
                <td>
                     <center><input type="submit" name="btn1" class="btn btn-primary" value="Registrar lote "></center>
                </td>
            </div>
        </form>
