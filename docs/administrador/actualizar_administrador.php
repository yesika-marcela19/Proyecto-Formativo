...
<html lang="en">
    <head>
       ...
       <script type="text/javascript">
        ...
        {
          var confirmar = confirm("¿Realmente desea actualizar administrador? ");
          if (confirmar)
          {
            return true;
          } 
    ...
    <div>
     ...
     <form action=" " method="POST">
          ...
          try {
            ...
            $sql = "SELECT * FROM persona INNER JOIN rol ON (fk_rol=id_rol) WHERE id_persona= " . $_REQUEST['enviar'] . " ";
              ...
              <div class="row">
                <div class="col-md-6">
                    <div>
                        ...
                        <td> <input class="form-control" type="number" name="uno" value="<?php echo $consulta['id_persona'] ?>"></td>
                    </div>
                    <div>
                        <label for="">Nombre</label>
                        <td> <input class="form-control" type="text" name="dos" value="<?php echo $consulta['nombre'] ?>"> </td>
                    </div>
                </div>
                <div class="col-md-6">
                    <div>
                        <label for="">Telefono</label>
                        <td> <input class="form-control" type="text" name="tres" value="<?php echo $consulta['telefono'] ?>"> </td>
                    </div>
    
                    <div>
                        <label for="exampleInputPassword1">Rol</label>
                        <select class="form-control" name="cuatro" id="" class="form_control">
                            <?php
                            try {
...
<?php
    ...
    $sql="UPDATE persona SET id_persona=:ide ,nombre=:nom,telefono=:tel,fk_rol=:rol WHERE id_persona=".$_REQUEST['enviar']." ; ";

    $resultado=$base->prepare($sql);

    $resultado->execute(array(":ide"=>$Identificacion ,":nom"=>$nombre,":tel"=>$telefono, ":rol"=>$rol)); 
    
     $resultado->closeCursor();
    ?>
    <script type="text/javascript">window.location="consulta_administrador.php"</script>
    <?php
  }
  ...
  # Recibo y cargo en variables los datos que vienen del formulario
