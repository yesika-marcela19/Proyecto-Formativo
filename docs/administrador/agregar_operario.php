...
<main class="app-content">
   <form method="POST" action="php/R_operario.php">
    <div class="app-title">

        <h1><i class="fa fa-dashboard"></i>Registro de operario</h1>
    </div>
</div>
...
<div>
    <td>
        <center><input type="submit" name="btn1" class="btn btn-primary" value="Registrar operario"></center>
    </td>
</div>
</form>
